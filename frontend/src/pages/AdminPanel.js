...
function AdminPanel() {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      alert("❌ Image upload fail — dobara try karo!");
    }
  ...
  const handleSubmit = async () => {
    if (!form.name || !form.price || !form.emoji) {
      alert("❌ Name, price aur emoji zaroor bharo!");
      return;
    }
    if (editItem) {
    ...
    <div style={{ padding: "20px", fontFamily: "Arial", maxWidth: "900px", margin: "0 auto" }}>
      ...
      {showForm && (
        <div style={{ background: "#f9f9f9", border: "1px solid #ddd", borderRadius: "12px", padding: "20px", marginBottom: "24px" }}>
          <h3 style={{ marginBottom: "16px" }}>{editItem ? "✏️ Item Edit Karo" : "➕ Naya Item Add Karo"}</h3>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
            <div>
              ...
              <input
                ...
                style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ddd", marginTop: "4px", boxSizing: "border-box" }}
              />
            </div>
            <div>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              <input
                ...
                placeholder="e.g. Crispy chicken burger with sauce"
                style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ddd", marginTop: "4px", boxSizing: "border-box" }}
              />
            </div>
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #ddd", marginTop: "4px", boxSizing: "border-box" }}
              />
              {imageUploading && <p style={{ color: "#888", fontSize: "13px" }}>⏳ Image upload ho rahi hai...</p>}
              {form.imageUrl && (
                <img src={form.imageUrl} alt="preview" style={{ width: "100px", height: "100px", objectFit: "cover", borderRadius: "8px", marginTop: "8px" }} />
              )}
            </div>
          </div>
          ...
          <button
            ...
            style={{ marginTop: "16px", background: "#2d6a4f", color: "white", border: "none", padding: "10px 24px", borderRadius: "8px", cursor: "pointer", fontSize: "15px" }}>
      ...
      {categories.map((cat) => {
        ...
        return (
          <div key={cat} style={{ marginBottom: "24px" }}>
            <h4 style={{ background: "#f0f0f0", padding: "8px 12px", borderRadius: "6px", marginBottom: "8px" }}>
              {cat}
            </h4>
            {catItems.map((item) => (
              <div key={item.id} style={{
                ...
                borderRadius: "8px",
                marginBottom: "8px",
                background: item.available ? "white" : "#f8f8f8",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
                  ...
                  <button
                    ...
                    style={{ background: item.available ? "#28a745" : "#dc3545", color: "white", border: "none", padding: "4px 10px", borderRadius: "4px", cursor: "pointer", fontSize: "12px" }}>
                    {item.available ? "Available" : "Unavailable"}
                  </button>
                  <button
                    onClick={() => handleEdit(item)}
                    style={{ background: "#007bff", color: "white", border: "none", padding: "4px 10px", borderRadius: "4px", cursor: "pointer", fontSize: "12px" }}>
                    ✏️ Edit
                  </button>
                  <button
                    onClick={() => handleDelete(item.id)}
                    style={{ background: "#dc3545", color: "white", border: "none", padding: "4px 10px", borderRadius: "4px", cursor: "pointer", fontSize: "12px" }}>
                    🗑️ Delete
                  </button>
                </div>
              </div>
